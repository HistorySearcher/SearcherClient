...
<%@ page import="com.project.lucene.main.SearchEngineSorter" %>
			...
			<div class="mainview view">
				...
				<header>
					...
					<div class="corner">
						...
						System.out.println("user: " + users);
													...
													//request.setCharacterEncoding("UTF-8");
								           		    ...
								           		    int scale = 12; //한 화면에 표시되는 글의 개수
								           			int pages = 0; //
								           			
								           			int total_page = 0;
								           			int total_record = beans.size();
								           			...
								           			pages = (request.getParameter("pages") == null) ? 1 : 
								           				Integer.parseInt(request.getParameter("pages"));
								           			
								           			
								           			//페이지 번호(page)에 따른 시작 레코드(start) 계산
								           			int start = (pages-1)*scale;
								           			int number = total_record - start;
					...
					<div class="controls">
						...
						<div class = "spinner"></div>
							<div class = "pagination" sytle="margin: 0; position: relative;">
								<ol class="pagination ">
								<% 
							...
							<li class="interval" data-id="1:15">
								...
								<ol class="visits highlightable editable">
								    ...
								    <% 
								           			...
								           			for (int i=start; i<start+scale && i<total_record; i++) {
								           				
								           				user = beans.get(i).getUserName();
								           				url = beans.get(i).getURL();
								           				title = beans.get(i).getTitle();								           				
								           				time = beans.get(i).getTime();
								           				data = beans.get(i).getContent();	
									...
									<li class="visit visit_view search" draggable="true">
